      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-serif text-gold-500 tracking-wide">PASTRY CORNER</h3>
            <p className="text-[10px] tracking-[0.3em] uppercase text-zinc-500">Artisan Patisserie</p>
            <p className="text-sm text-zinc-400 leading-relaxed font-light">
              Crafting exquisite pastries and baked goods with passion and precision.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                <svg className="w-4 h-4 text-green-500/60 group-hover:text-green-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                href="https://www.instagram.com/thepastrycorner_1" 
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-sm text-zinc-300 hover:text-pink-500 transition-colors group"
              >
                <svg className="w-4 h-4 text-pink-500/60 group-hover:text-pink-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="font-light">@thepastrycorner_1</span>
              </a>
            </div>
          </div>
          ...
          {/* Hours */}
          <div className="space-y-4">
            <h4 className="text-[11px] tracking-[0.3em] uppercase text-gold-500 font-medium">Hours</h4>
            <div className="space-y-2 text-sm text-zinc-400 font-light">
              <p>Monday - Saturday</p>
              <p className="text-zinc-500">9:00 AM - 8:00 PM</p>
              <p className="mt-3">Sunday</p>
              <p className="text-zinc-500">10:00 AM - 6:00 PM</p>
            </div>
          </div>
        </div>
